...
sealed abstract class MonoidLawsProp[A](description: String)
                                       (implicit arbitrary: Arbitrary[A], ev: Monoid[A])
...
object IntAdditionMonoidLawsProp
  extends MonoidLawsProp[Int]("intAddition")(arbInt, intAdditionMonoid)
...
object BooleanAndMonoidLawsProp
  extends MonoidLawsProp[Boolean]("booleanAnd")(arbBool, booleanAndMonoid)

object BooleanOrMonoidLawsProp
  extends MonoidLawsProp[Boolean]("booleanOr")(arbBool, booleanOrMonoid)
